...
// index.html staat gewoon in de hoofdmap — geen public-map nodig
const indexPad = require("fs").existsSync(path.join(__dirname, "public", "index.html"))
  ? path.join(__dirname, "public", "index.html")
  : path.join(__dirname, "index.html");
app.get("*", (req, res) => res.sendFile(indexPad));
